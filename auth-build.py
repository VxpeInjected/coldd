...
ROBLOX = '<svg viewBox="0 0 24 24" fill="#fff" fill-rule="evenodd" clip-rule="evenodd"><path d="M5.164 0 0 19.236 18.836 24 24 4.764 5.164 0Zm6.875 9.473 5.31 1.353-1.354 5.31-5.31-1.353 1.354-5.31z"/></svg>'
