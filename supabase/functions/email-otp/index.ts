...
<table cellpadding="0" cellspacing="0" border="0" style="background:linear-gradient(135deg,#cc0011 0%,#ff3344 100%);border-radius:5px;">
<tr><td style="padding:18px 34px;">
<p style="margin:0;font-family:'Courier New',Courier,monospace;font-size:34px;font-weight:700;letter-spacing:10px;color:#ffffff;">${code}</p>
</td></tr>
</table>
</td></tr>
</table>
