// supabase/functions/admin-delete-content/index.ts
//
// Deploy with:
//   supabase functions deploy admin-delete-content
//
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (delErr) return json({ ok: false, error: "Could not delete content." }, 500);
