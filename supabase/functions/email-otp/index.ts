...
<tr><td align="center">
<table width="560" cellpadding="0" cellspacing="0" border="0" style="width:560px;background-color:#0b0b0b;border-radius:10px;border:1px solid #7a2233;">
<tr><td style="background-color:#c2394a;height:2px;line-height:2px;font-size:2px;border-radius:10px 10px 0 0;">&nbsp;</td></tr>

<tr><td style="padding:40px 44px 8px;">
<p style="margin:0;font-size:9px;letter-spacing:4px;color:#d94f60;text-transform:uppercase;font-weight:700;font-family:Arial,Helvetica,sans-serif;">coldd Development</p>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#111111;background-image:url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2216%22%20height%3D%2216%22%3E%3Ccircle%20cx%3D%228%22%20cy%3D%228%22%20r%3D%221%22%20fill%3D%22%23ffffff%22%20opacity%3D%220.055%22%2F%3E%3C%2Fsvg%3E');border-radius:8px;border:1px solid #1a1a1a;">
<tr><td align="center" style="padding:28px 22px;">
<table cellpadding="0" cellspacing="0" border="0" style="background-color:#c2394a;border-radius:6px;">
<tr><td align="center" style="padding:18px 26px 18px 32px;">
<span style="font-family:'SFMono-Regular',Consolas,Menlo,'Liberation Mono',monospace;font-size:32px;font-weight:700;letter-spacing:6px;color:#ffffff;">${code}</span>
</td></tr>
</table>
</td></tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="border-top:1px solid #181818;font-size:0;line-height:0;">&nbsp;</td></tr></table>
</td></tr>
...
Need help? Contact <a href="mailto:support@coldd.dev" style="color:#d94f60;text-decoration:none;">support@coldd.dev</a>.<br>
...
<tr><td style="background-color:#070707;border-top:1px solid #141414;padding:18px 44px;border-radius:0 0 10px 10px;">
